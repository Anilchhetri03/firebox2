...
<main class="ttr-wrapper">
	<div class="container-fluid">
		<div class="db-breadcrumb">
			<h4 class="breadcrumb-title">contact us for any Queries</h4>
		...
		if (isset($_POST['submit'])) {
			...
			$query = "INSERT INTO contact_us(name, message, phone,email) VALUES ( '$name','$message', '$phone',  '$email')";
		...
		?>
			...
			?>
				<div class="alert alert-danger alert-dismissible fade show" role="alert">
					...
					<strong> couldn't be added successfully.</strong>
