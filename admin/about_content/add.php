            ...
            if ($filesize <= 3000000) {
                if ($extention == 'jpg' || $extention == 'JPG' || $extention == 'PNG' || $extention == 'png' || $extention == 'jpeg') {
                    if (move_uploaded_file($_FILES['dataFile']['tmp_name'], "../uploads/" . $finalfile)) {
                        $query = "INSERT INTO about_page (title1,subtitle1,img1,decp1,title2,subtitle2,img2,decp2) VALUES ('$title1','$subtitle1','$finalfile','$ftype1','$title2','$subtitle2','$finalfile2','$ftype2')";
                        ...
                        <form class="edit-profile m-b30" form action="#" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group col-12">
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" class="form-control" name="title1" id="" aria-describedby="helpId" placeholder="">
                                        </div>
                                        <div class="form-group col-md-12">
                                            <label for="">Sub_Title</label>
                                            <input type="text" class="form-control" name="subtitle1" id="" aria-describedby="helpId" placeholder="">
                                        </div>
                                        <div class="form-group col-md-12">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" class="form-control" name="decp1" id="" aria-describedby="helpId" placeholder="">
                                        </div>
                                        <div class="form-group col-md-12">
                                            <label for="">Title1</label>
                                            <input type="text" class="form-control" name="title2" id="" aria-describedby="helpId" placeholder="">
                                        </div>
                                        <div class="form-group col-12">
                                            <div class="form-group col-md-12">
                                                <label for="">Sub_Title</label>
                                                <input type="text" class="form-control" name="subtitle2" id="" aria-describedby="helpId" placeholder="">
                                            </div>
                                            <div class="form-group col-md-12">
                                                <label for="">Image</label>
                                                <input type="file" class="form-control" name="dataFile" id="" aria-describedby="helpId" placeholder="">
                                            ...
                                            <div class="form-group col-md-12">
                                                <label for="">Description</label>
                                                <input type="text" class="form-control" name="decp2" id="" aria-describedby="helpId" placeholder="">
                                            </div>
                                            <div class="col-12">
