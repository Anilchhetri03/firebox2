                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><img src="<?php echo "../uploads/" . $data_select['img']; ?>" alt="" height="150px;" width="200px;"></td>
                                <td scope="row"><?php echo $data_select['decp'];  ?></td>
                                <td>
                                    <a name="" id="" class="btn btn-danger btn-sm" href="delete.php?id=<?php echo $data_select['id']; ?>" role="button">Delete</a>
                                    <a name="" id="" class="btn btn-primary btn-sm" href="update.php?id=<?php echo $data_select['id']; ?>" role="button">Edit</a>
                                </td>
                            </tr>
                        <?php
                        }
